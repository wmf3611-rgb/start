    ...
    ko: {
        ...
        data: {
            ...
            'ISTP': {
                ...
                famous: '베어 그릴스, 마이클 조던, 톰 크루즈, 뮬란(가상 인물)',
                compatibility: 'ESFJ, ESTJ와 잘 맞습니다. 실용적인 면모를 갖추면서도 자신의 독립성을 존중해주는 파트너를 선호합니다.',
                dating: '자유를 중요하게 생각하며 상대방도 독립적인 사람인 것을 선호합니다. 말보다는 함께 활동하거나 실질적인 도움을 주며 사랑을 표현합니다.',
                communication: '간결하고 객관적이며 행동 중심적입니다. 철학적인 "왜"보다는 기술적인 "어떻게"에 대해 대화하는 것을 즐깁니다.',
                caution: '그들을 통제하거나 사소한 것까지 간섭하려 하지 마세요. 물리적인 공간을 확보해주고 그들의 자율성을 인정해주는 것이 중요합니다.'
            },
            'ISFP': {
                name: '호기심 많은 예술가',
                ...
                compatibility: 'ENFJ, ESFJ와 좋은 관계를 유지합니다. 자신의 예술성을 알아주고 정서적으로 따뜻하게 대해주는 파트너가 필요합니다.',
                dating: '낭만적이고 충실한 연인이지만 자신만의 공간이 필수적입니다. 맛있는 음식, 음악, 여행 같은 감각적인 경험을 함께 나누는 것을 좋아합니다.',
                communication: '조용하고 관찰력이 좋으며 비판적이지 않습니다. 긴 설명보다는 행동이나 예술적인 매체를 통해 소통하는 편입니다.',
                caution: '지나치게 비판적이거나 몰아붙이는 태도는 피하세요. 그들의 창의적인 자유와 사생활을 존중해 주어야 합니다.'
            },
            'ESTP': {
                name: '모험을 즐기는 사업가',
                ...
                famous: '도널드 트럼프, 마돈나, 브루스 윌리스, 사무엘 L. 잭슨',
                compatibility: 'ISFJ, ISTJ와 잘 맞습니다. 믿음직하면서도 자신의 빠른 삶의 속도를 맞출 수 있는 파트너를 원합니다.',
                dating: '흥미진진하고 모험적이며 솔직합니다. 신체적 교감과 활동적인 데이트를 즐기며, 자신만큼 활기찬 에너지를 가진 사람을 찾습니다.',
                communication: '활기차고 직설적이며 현재 상황에 집중합니다. 유머 감각이 뛰어나며 이야기를 재미있게 들려주는 능력이 있습니다.',
                caution: '너무 많은 계획으로 그들을 억제하려 하지 마세요. 직접적으로 소통하고 그들의 높은 에너지 수준을 맞춰주는 것이 좋습니다.'
            },
            'ESFP': {
                name: '자유로운 영혼의 연예인',
                ...
                compatibility: 'ISFJ, ISTJ와 궁합이 좋습니다. 안정을 제공하면서도 자신의 사교적인 에너지를 지지해줄 파트너가 필요합니다.',
                dating: '장난기 많고 애정 표현이 풍부하며 재미를 추구합니다. 관계의 변화와 설렘을 좋아하며 선물이나 깜짝 이벤트로 연인을 즐겁게 합니다.',
                communication: '친근하고 활기차며 이야기 중심적입니다. 자신의 경험을 공유하는 것을 좋아하며 생생한 묘사를 자주 사용합니다.',
                caution: '그들의 아이디어와 사교적인 에너지에 열정적으로 반응해 주세요. 너무 비판적이거나 먼 미래의 추상적인 계획만 늘어놓는 것은 좋지 않습니다.'
            }
        }
    },
    ja: {
